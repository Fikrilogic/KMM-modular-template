    ...
    override fun Content() {
        Scaffold(
            ...
            Column(
                ...
                Column(verticalArrangement = Arrangement.spacedBy(MainAppTheme.spacing.md)) {
                    Row(
                        ...
                        Text("00:25", style = MaterialTheme.typography.titleLarge)
                    }
                    CountryFlagContent(
                        modifier = Modifier
                            .fillMaxWidth()
...
@Composable
@Preview
fun SurvivalGamePreview() {
    AppTheme {
        SurvivalGameView().Content()
    }
}